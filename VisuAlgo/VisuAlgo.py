...
def restart():
    ...
    def main():
        ...
        bg = (pygame.image.load(resource_path('background.png')), (-80,0))
        ...
        col1 = (255,0,255)
        col2 = (0,255,255)
        randommaze_area = [200,height/2,200,50]
        createmaze_area = [740,height/2,260,50]
        dfs_area = [200,height/2,200,50]
        bfs_area = [740,height/2,200,50]
        ...
        randomdisplay2 = True
        randomdisplay = False
        starttext = pygame.font.Font(resource_path('FreeSansBold.ttf'),22,bold=True)
            ...
            if not winflag:
                ...
                if buttonarea(mouse, randommaze_area):
                    if button1:
                        buttonsound1.play()
                        button1 = False
                    createbutton(win , col1, randommaze_area)
                else:
                    button1 = True
                    createbutton(win , col2, randommaze_area)
                ...
                if buttonarea(mouse, createmaze_area):
                    if button2:
                        buttonsound1.play()
                        button2 = False
                    createbutton(win , col1, createmaze_area)
                else:
                    button2 = True
                    createbutton(win , col2, createmaze_area)
            ...
            if winflag and not (bfsflag or dfsflag):
                ...
                if buttonarea(mouse, dfs_area):
                    if button3:
                        buttonsound1.play()
                        button3 = False
                    createbutton(win , col1, dfs_area)
                else:
                    button3 = True
                    createbutton(win , col2, dfs_area)
                ...
                if buttonarea(mouse, bfs_area):
                    if button4:
                        buttonsound1.play()
                        button4 = False
                    createbutton(win , col1, bfs_area)
                else:
                    button4 = True
                    createbutton(win , col2, bfs_area)
                ...
                if buttonarea(mouse, back_area):
                    if button5:
                        buttonsound1.play()
                        button5 = False
                    createbutton(win , col1, back_area)
                else:
                    button5 = True
                    createbutton(win , col2, back_area)
