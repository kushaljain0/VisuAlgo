...
def restart():
    ...
    #game icon
    programIcon = pygame.image.load(resource_path('icon.png'))
    ...
    class MySprite(pygame.sprite.Sprite):
        def __init__(self):
            ...
            self.rect = pygame.Rect(-40,-82,1320, 850)
    ...
    bfs = pygame.image.load('bfs.png')
    dfs= pygame.image.load('dfs.png')
    bfs2 = pygame.image.load('bfs2.png')
    dfs2 = pygame.image.load('dfs2.png')
    ...
    class Spot:
        ...
        def show(self, win, col, shape= 1):
            ...
            if shape == 1:
                ...
                pygame.draw.rect(win, col, (self.x*w+17 , self.y*h+17 , 5 , 5))
            else:
    ...
    def main():
        ...
        while True:
                ...
                if not startflag:   
                    if event.type == pygame.MOUSEBUTTONDOWN:
                        if event.button in (1, 3):
                            ...
                            if 390<=mouse[0]<=860 and height/4+100<=mouse[1]<=height/4 + 150 and event.button==1 and winflag and not bfsflag:
                                if not click1:
                                    buttonsound2.play()
                                    click1=True
                                dfsflag=True
                            ...
                            if 390<=mouse[0]<=860 and height/4 + 210<=mouse[1]<=height/4 + 260 and event.button==1 and winflag and not dfsflag:
                                if not click1:
                                    buttonsound2.play()
                                    click1=True
                                bfsflag=True
                            ...
                            if 390<=mouse[0]<=860  and height/4 + 100<=mouse[1]<=height/4 + 150 and randomflag==0 and event.button==1 and not winflag:
                                if click1:
                                    buttonsound2.play()
                                    click1=False
                            ...
                            if 390<=mouse[0]<=860  and height/4 + 210<=mouse[1]<=height/4 + 260 and event.button==1 and not winflag:
                                if click1:
                                    buttonsound2.play()
                                    click1=False
                                winflag=True
            ...
            if not winflag:
                if 390<=mouse[0]<=860 and height/4 + 100<=mouse[1]<=height/4 + 150:
                    ...
                    if not randomdisplay:
                        ...
                        randomdisplay=True
                elif 390<mouse[0]<860 and height/4 + 210<mouse[1]<height/4 + 260:
                    my_group.update(stop=False)
                    randomdisplay=False
                ...
                if 390<=mouse[0]<=860 and height/4 + 210<=mouse[1]<=height/4 + 260:
                    win.fill((0,0,0))
                    for i in range(cols):
                        for j in range(rows):
                            spot = grid[i][j]
                ...
                if 390<=mouse[0]<=860 and height/4+100<=mouse[1]<=height/4 + 150:
                    ...
                    win.blit(SampleMaze2,(390,height/4+90))
                    if button1:
                        buttonsound1.play()
                        button1=False
                    #pygame.draw.rect(win,(255,0,255),[200,height/2,200,50])
                else:
                    win.blit(SampleMaze,(390,height/4+90))
                    button1=True
                ...
                if 390<=mouse[0]<=860 and height/4 + 210<=mouse[1]<=height/4 + 260:
                    ...
                    win.blit(CreateMaze2,(395,height/4+200))
                    if button2:
                        buttonsound1.play()
                        button2=False
                    #pygame.draw.rect(win,(255,0,255),[740,height/2,260,50])
                else:
                    win.blit(CreateMaze,(395,height/4+200))
                    button2=True
                ...
                if not randomdisplay2:
                    ...
                    for i in range(cols):
                        for j in range(rows):
                            spot = grid[i][j]
                            spot.show(win, (160, 160, 200))
                if 540<=mouse[0]<=750 and height/4+100<=mouse[1]<=height/4 + 150:
                    win.blit(dfs2,(550,height/4+90))
                    if button3:
                        buttonsound1.play()
                        button3=False 
                else:
                    button3=True
                    win.blit(dfs,(550,height/4+90))

                if 540<=mouse[0]<=750 and height/4 + 210<=mouse[1]<=height/4 + 260:
                    win.blit(bfs2,(550,height/4+200))
                    if button4:
                        buttonsound1.play()
                        button4=False
                else:
                    button4=True
                    win.blit(bfs,(550,height/4+200))


                if 20<=mouse[0]<=120 and 20<=mouse[1]<=60:
                    win.blit(back2,(20,20))
                    if button5:
                        buttonsound1.play()
                        button5=False
            ...
            if dfsflag or bfsflag:
                ...
                for i in range(cols):
                    for j in range(rows):
                        ...
                        spot.show(win, (160, 160, 200))
                        if spot in path:
                            spot.show(win, (251, 255, 97))
                            spot.show(win, (0,0,0),0)
                        elif spot.visited:
                            spot.show(win, (51, 229, 255))
                        if spot in queue and not flag:
                            spot.show(win, (233 , 8 , 90))
                        if startpoint: 
                            if spot == start:
                                spot.show(win,(0,0,0))
                                spot.show(win, (210,0,0),2)
                        if endpoint:
                            if spot == end:
                                spot.show(win, (0, 0, 0))
                                spot.show(win, (0,255,0),2)
                                
                if not startpoint:
                    setposition.show(win,(0,0,0))
                    setposition.show(win, (210,0,0),2)
                if startpoint and not endpoint:
                    if setposition!=start:
                        setposition.show(win,(0,0,0))
                        setposition.show(win, (0,255,0),2)   
